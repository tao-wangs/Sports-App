        ...
        <div className="hostPage__box">
          ...
          <form onSubmit={this.handleSubmit}>
            ...
            <Row>
              ...
              />
            <Button className="upload-button" onClick={this.handleImageUpload}>Upload</Button>
            </Row>
            <Row>
            <input variant="outlined" className="btn btn-secondary form-control mr-sm-2 m-2" type="submit" value="Submit Event" />
            </Row>
            {this.state.image === "" ? (
              <p />
            ) : (
